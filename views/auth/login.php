    ...
    <section class="login-content overflow-hidden">
        <div class="row no-gutters align-items-center bg-white">
            <div class="col-md-12 col-lg-6 align-self-center">
                <div class="col-md-12 d-flex justify-content-center col-lg-12 align-self-center">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="?page=auth/login">
                                    ...
                                    <p class="mt-3 text-center">
                                        Don’t have an account? <a href="?page=auth/register" class="text-underline">Click here to sign up.</a>
                                    </p>
                                </form>
                            </div>
                        </div>
