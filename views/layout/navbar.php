                                ...
                                <div class="p-0 card-body all-notification">
                                    <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/64.jpg"
                                    ...
                                    <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/02.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="d-flex align-items-center search-hover py-2 px-3 border-bottom">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/03.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/04.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                            <a href="javascript:void(0);" class="h5">Monty Carlo</a>
                ...
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                        ...
                        <ul class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="search-drop">
                            <li class="">
                                ...
                                <div class="p-0 card-body all-notification">
                                    ...
                                    <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/55.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="d-flex align-items-center search-hover py-2 px-3 border-bottom">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/56.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                                        <div class="flex-shrink-0">
                                            <img src="/public/images/dashboard/57.png"
                                                class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                        </div>
                                        <div class="d-flex flex-column ms-3 w-100">
                                ...
                                <div class="p-0 card-body all-notification">
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="/public/images/dashboard/24.png" alt="" loading="lazy">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                    src="/public/images/dashboard/25.png" alt="" loading="lazy">
                                            </div>
                                            <div class="ms-3 w-100">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="/public/images/dashboard/26.png" alt="" loading="lazy">
                                            <div class="ms-3 w-100">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="/public/images/dashboard/27.png" alt="" loading="lazy">
                    ...
                    <li class="nav-item dropdown">
                        <a class="p-0 ps-3 nav-link d-flex align-items-center position-relative" href="#" id="profile-setting" role="button"
                            ...
                            <img src="/public/images/dashboard/64.jpg" alt="User-Profile"
